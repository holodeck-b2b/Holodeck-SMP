...
/**
 * Defines the Identifier based search and duplicate check capabilities for the {@link EndpointEntity} based repository.
 *
 * @author Sander Fieten (sander at holodeck-b2b.org)
 */
interface TransportProfileIdCapableRepo extends UniqueIdMDRRepo<Identifier, TransportProfileEntity> {
}
