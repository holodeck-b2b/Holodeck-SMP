...
/**
 * Defines the Identifier based search and duplicate check capabilities for the {@link ServiceEntity} based repository.
 *
 * @author Sander Fieten (sander at holodeck-b2b.org)
 */
public interface ServiceIdCapableRepo extends UniqueIdMDRRepo<Identifier, ServiceEntity> {
}
