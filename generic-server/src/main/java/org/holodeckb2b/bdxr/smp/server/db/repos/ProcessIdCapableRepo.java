...
/**
 * Defines the Identifier based search and duplicate check capabilities for the {@link ProcessEntity} based repository.
 *
 * @author Sander Fieten (sander at holodeck-b2b.org)
 */
interface ProcessIdCapableRepo extends UniqueIdMDRRepo<ProcessIdentifier, ProcessEntity> {
